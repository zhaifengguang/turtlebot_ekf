...
#Node that will make Mr.Turtle Turtlism follow a happy 8 (hopefully!)
#Turtlesim used geometry_msgs/Twist message instead of Velocity
#Subscirbed topic is turtleX/cmd_vel(geometry_msgs/Twist). Linear and 
#angular command velocity for Mr.Turtle. He will exectue this command for 
#1 second and time out. The input topic for the minic node. The topic must be remapped to the cmd
#_vel topic of the mimiicking turtle
#Publioshed topic is turtleX/pose (turtlesim/Pose): the x, y theta, linear a
#and angular velocity of Mr.Turle. 
#the output topic (geometry_msgs/Twist) for the mimic node. The topic
#must be remaped to the cmd_vel topic of the mimicking robot. 
    #include <ros/ros.h>
